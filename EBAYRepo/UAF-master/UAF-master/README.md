...
- [2016.03.28 - Added Login/Logout APIS and MySQL server Database Storage Support]
- [2016.04.21 - Added support for IOS device requests (ECDSA Keys)]
- [2016.05.03 - Added new functionalities of push notifications, generate OTP and send SMS to mobile device, Added new Relying Party (Vendor) APIs, changed existing Login/Logout and Registration APIs]
