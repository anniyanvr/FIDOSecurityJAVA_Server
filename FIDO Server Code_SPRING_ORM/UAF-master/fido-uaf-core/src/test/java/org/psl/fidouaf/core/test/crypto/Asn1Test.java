...
public class Asn1Test {
	...
	public void test() throws IOException {
		...
		BigInteger[] bigIntegerArray = Asn1.decodeToBigIntegerArray(Base64
				.decodeBase64(signatureB64));
		byte[] encoded = Asn1.getEncoded(bigIntegerArray);
		assertTrue(signatureB64.equals(Base64
				.encodeBase64URLSafeString(encoded)));
	}
	...
	public void rickSafeURLEncoding() throws IOException {
		...
		BigInteger[] bigIntegerArray = Asn1.decodeToBigIntegerArray(Base64
				.decodeBase64(signatureB64));
		BigInteger[] bigIntegerArrayFromURLSafe = Asn1
				.decodeToBigIntegerArray(Base64.decodeBase64(signatureB64Safe));
