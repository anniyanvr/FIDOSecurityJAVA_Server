...
import org.psl.fidouaf.core.exceptions.InvalidArgumentException;
import org.psl.fidouaf.core.tlv.AlgAndEncodingEnum;
import org.psl.fidouaf.core.tlv.TagAssertionInfo;
...
public class TagAssertionInfoTest {
	...
	public void parserForRegAssertion() throws IOException,
		...
		TagAssertionInfo info = new TagAssertionInfo(list.getTags().get(
				TagsEnum.TAG_ASSERTION_INFO.id));
	...
	@Test
	public void parserForRegAssertionFromCertTool() throws IOException,
			InvalidArgumentException {
		String raw = null;
		Tags list = null;
	...
	@Test
	public void parserForRegAssertionFromTestClient() throws IOException,
			InvalidArgumentException {
		String raw = null;
		Tags list = null;
