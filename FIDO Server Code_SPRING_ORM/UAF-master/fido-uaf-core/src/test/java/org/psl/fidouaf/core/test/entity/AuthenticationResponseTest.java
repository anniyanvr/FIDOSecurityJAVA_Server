package org.psl.fidouaf.core.test.entity;
...
public class AuthenticationResponseTest {
	...
	@Test
	public void test() {
		AuthenticationResponse authResponse = gson.fromJson(
				getTestAuthResponse(), AuthenticationResponse.class);
	...
	/*
	 * @Test public void noNullInJson() { AuthenticationResponse authResponse =
	 * new AuthenticationResponse(); authResponse.assertions = new
	 * AuthenticatorSignAssertion[1]; authResponse.assertions[0] = new
	 * AuthenticatorSignAssertion(); authResponse.assertions[0].assertion =
	 * "SOMETHING"; String json = gson.toJson(authResponse); logger.info(json);
	 * assertTrue(!json.contains("null"));
