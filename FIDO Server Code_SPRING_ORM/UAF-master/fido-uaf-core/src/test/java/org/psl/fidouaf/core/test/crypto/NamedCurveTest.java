...
public class NamedCurveTest {
	...
	public void signatureAndPubKey() throws InvalidKeySpecException,
			...
			Exception {
		// String signatureB64 =
		// "MEUCIQCw-7e95D8hqCC2fxw1ChrCBZ13ZDAtwpDV8f2DQx7G2wIgN0kTb0FShW5fzMHni3sge6PtZM2RMc8Hx-tp0B_2PXg=";
		// String pubKeyB64 =
		...
		byte[] dataForSigning = SHA.sha(Base64.decodeBase64(dataForSigningStr),
				"SHA-256");
	...
	public void testRawPubKey() throws Exception {
		...
		PrivateKey priv = KeyCodec.getPrivKeyFromCurve(privKeyBytes,
				"secp256r1");
		assertNotNull(pub);
		assertNotNull(priv);

		String signature = "MEQCIAwtk4DStr2MqkrAlOVG+nyQxbS6tnBpVi7OcKCm8/5lAiBjVsv+b+7nI/306iNHrso/ruOaxY8IJy3jw2/zr17JEQ==";
		BigInteger[] rs = Asn1.decodeToBigIntegerArray(Base64
				.decodeBase64(signature));

		byte[] dataForSigning = Base64
				.decodeBase64("VGhpcyBpcyBzb21lIHJhbmRvbSBkYXRhIHRvIGJlIHNpZ25lZCBieSBhIHByaXZhdGUga2V5IGFuZCB0aGVuIHZlcmlmaWVkLg");
