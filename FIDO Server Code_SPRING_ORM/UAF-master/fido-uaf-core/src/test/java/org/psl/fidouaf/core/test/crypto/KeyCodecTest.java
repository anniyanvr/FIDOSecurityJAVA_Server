...
public class KeyCodecTest {
	...
	@Test
	public void pss() throws InvalidAlgorithmParameterException,
			NoSuchAlgorithmException, NoSuchProviderException,
			DataLengthException, CryptoException, InvalidKeyException,
		...
		byte[] slt = Hex.decode("dee959c7e06411361420ff80185ed57f3e6776af"); // a
																				// random
																				// salt
		byte[] signed = RSA.signPSS(privKey, slt);
		assertTrue(signed.length > 0);
		Assert.assertTrue(RSA.verifyPSS(publicKey, slt, signed));
		byte[] slt2 = Hex.decode("dee959c7e06411361420ff80185ed57f3e6776aa"); // a
																				// random
																				// salt
	...
	@Test
	public void pssDER() throws InvalidAlgorithmParameterException,
			NoSuchAlgorithmException, NoSuchProviderException,
			DataLengthException, CryptoException, InvalidKeyException,
			SignatureException, InvalidKeySpecException, IOException {
		KeyPair keyPair = KeyCodec.getRSAKeyPair();
