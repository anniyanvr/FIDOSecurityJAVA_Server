...
import org.psl.fidouaf.core.crypto.RSA;
...
import org.psl.fidouaf.core.exceptions.DataRecordNotFoundException;
import org.psl.fidouaf.core.exceptions.ServerDataSignatureNotMatchException;
import org.psl.fidouaf.core.tlv.AlgAndEncodingEnum;
...
public class AuthenticationResponseProcessing {
	...
	public List<AuthenticatorRecord> verify(AuthenticationResponse response,
			StorageInterface serverData) throws Exception {

		// List<AuthenticatorRecord> records = new
		// ArrayList<AuthenticatorRecord>();
		AuthenticatorRecord[] records = new AuthenticatorRecord[response
				.getAssertions().size()];
		...
		List<AuthenticatorRecord> recordsList = new ArrayList<AuthenticatorRecord>(
	...
	private RegistrationRecord getRegistrationRecordFrmDB(
			...
			throws IOException, DataRecordNotFoundException {
