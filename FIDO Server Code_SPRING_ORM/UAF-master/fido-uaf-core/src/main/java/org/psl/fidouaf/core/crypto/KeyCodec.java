...
public class KeyCodec {
	...
	public static PublicKey getRSAPublicKey(byte[] encodedPubKey)
		...
		RSAPublicKey pubKey8 = (RSAPublicKey) RSAPublicKey
				.getInstance(encodedPubKey);
		SubjectPublicKeyInfo info = SubjectPublicKeyInfoFactory
				.createSubjectPublicKeyInfo(new RSAKeyParameters(false, pubKey8
						.getModulus(), pubKey8.getPublicExponent()));
	...
	// New code added here....
	/**
	 * Added code for IOS (RSA keys) compatibility.
	 * 
	 * @param encodedPubKey
	 * @return
	 * @throws IOException
	 ...
	 * @throws InvalidKeySpecException
	 */
	public static PublicKey getPublicKey(byte[] encodedPubKey)
			throws IOException, NoSuchAlgorithmException,
			InvalidKeySpecException {
