...
public class RSA {
	...
	public static boolean verify(X509Certificate x509Certificate,
		...
		/** commented below part due to IOS compatibility */
	...
	public static byte[] signPSS(PrivateKey privateKey, byte[] signedData)
			throws SignatureException, InvalidKeyException,
			NoSuchAlgorithmException, NoSuchProviderException,
			InvalidAlgorithmParameterException {
	...
	public static boolean verifyPSS(PublicKey publicKey, byte[] signedData,
			byte[] sig) throws SignatureException, InvalidKeyException,
			NoSuchAlgorithmException, NoSuchProviderException,
	...
	// New code added here...
	/**
	 * Method added to verify simple RSA signature - key verification for
	 * IOS(RSA keys).
	 * 
	 * @param publicKey
	 * @param signedData
	 ...
	 */
	public static boolean verifySimpleRSA(PublicKey publicKey,
